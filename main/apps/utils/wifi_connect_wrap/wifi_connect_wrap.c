...
#define CONFIG_EXAMPLE_WIFI_SSID                    "6"
#define CONFIG_EXAMPLE_WIFI_PASSWORD                "6"
...
static esp_netif_t *wifi_start(void)
{
    ...
    // Copy shit 
    strcpy((char*)&wifi_config.sta.ssid, _wifi_ssid);
    strcpy((char*)&wifi_config.sta.password, _wifi_password);
